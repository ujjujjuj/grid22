...
const Product = ({
    product = { name: "Example Product", price: 42000, image: "", isSoulbound: false, features: [] },
    shimmer = false,
    selectHook,
    resale,
}) => {
    ...
    return (
        <div
            className={classNames(styles.productCard, shimmer ? styles.shimmer : "")}
            onClick={shimmer ? () => {} : openProduct}
        >
            <div
